                ...
                <div className="2xs:flex-col 2xs:gap-16 lg:flex-row flex gap-24">
                    <div className="pt-[50px] 2xs:flex-col 2xs:items-center lg:items-start flex ">
                        ...
                        <div className="relative flex flex-row mt-5">
                            ...
                            <button type="submit" className=" absolute  top-0 right-0 bg-black text-white w-[40px] h-[40px] flex items-center justify-center"><img src={Message} alt="" className="w-[15px] h-[12px] !text-white !fill-white" /></button>
                        </div>
