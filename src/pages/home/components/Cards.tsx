    ...
    return (
        <section
            ...
            <div className=" bg-white px-[15px] py-[15px] lg:px-[30px] lg:py-[40px] cursor-pointer scale-100 overflow-hidden relative z-10 hover:bg-primary hover:text-black hover:transition-all hover:delay-300 hover:ease-out">
                ...
                <div className="px-4 py-3  h-[150px] lg:h-[200px] bg-primary text-center absolute left-0 bottom-0 z-[-1]  w-full">
                    <span className="text-white mr-3  capitalize inline-block text-lg lg:text-2xl font-semibold mb-[15px]">New Collection</span>
