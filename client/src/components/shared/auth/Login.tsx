...
export const Login = ({ onSwitch }: { onSwitch: any }) => {
                ...
                <div className="md:w-full p-6 sm:p-12 flex flex-col justify-center">
                    ...
                    <div className="mt-12">
                        <div className="flex flex-col items-center">
                            <button className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-red-50 text-gray-800 flex items-center justify-center transition-all duration-300 focus:outline-none hover:shadow-md">
                            ...
                            <button className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-red-50 text-gray-800 flex items-center justify-center transition-all duration-300 focus:outline-none hover:shadow-md mt-5">
                        ...
                        <form className="mx-auto max-w-xs">
                            <input className="w-full px-8 py-4 rounded-lg bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none " type="email" placeholder="Email address" />
                        ...
                        <p className="mt-6 text-sm flex items-center justify-center gap-2 text-black">
                            Don’t have an account? <p className="text-gray-600 font-medium hover:text-primary cursor-pointer" onClick={onSwitch}>Register now</p>
                        </p>
                    </div>
                </div>
