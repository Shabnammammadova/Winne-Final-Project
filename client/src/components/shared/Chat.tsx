    ...
    return (
        <div>
            <button
                ...
                className=" z-20 fixed bottom-4 right-4 inline-flex items-center justify-center text-sm font-medium disabled:pointer-events-none disabled:opacity-50 border rounded-full w-16 h-16 bg-primary  m-0 cursor-pointer border-gray-200 bg-none p-0 normal-case leading-5 "
            ...
            {isOpen &&
                <div
                    className=" z-20 fixed bottom-[calc(4rem+1.5rem)] right-0 mr-4 bg-white p-6 rounded-lg border border-[#e5e7eb] w-[440px] h-[434px]">
                    ...
                    <div className="pr-4 h-[474px]">
                        ...
                        <div className="flex gap-3 my-4 text-gray-600 text-sm flex-1 justify-end">
