...
const ChatPage = () => {
    ...
    if (isLoading || isChatLoading) return (
        <Spinner />
    )
            ...
            <div className="flex flex-row h-full w-full overflow-x-hidden bg-white">
                <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
                    <div className="flex flex-row items-center justify-center h-12 w-full">
                        <div
                            className="flex items-center justify-center rounded-2xl text-red-700 bg-primary-100 h-10 w-10"
                        >
                            <svg
                                className="w-6 h-6"
                                fill="none"
                    ...
                    <div
                        className="flex flex-col items-center bg-transparent border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg"
                    >
                        ...
                        <div className="flex flex-col space-y-1 mt-4 -mx-2 h-48 overflow-y-auto">

                            {
                                conversations.map((conversation) => (
                                    ...
                                    >
                                        <div
                                            className="flex uppercase  items-center justify-center h-8 w-8 bg-primary rounded-full"
                                        >
                            ...
                            >
                                ...
                                <div className="ml-4">
                                    <button type="submit" form="chat-form"
                                        className="flex items-center justify-center bg-primary  rounded-xl text-white px-4 py-1 flex-shrink-0"
                                    >
                                        <span>Send</span>
                                        <span className="ml-2">
                                            <svg
    ...
    return (
        <div className={cn(" p-3 rounded-lg",
            ...
            <div className={cn("flex  items-center", owner && "justify-start flex-row-reverse")}>
                ...
                <div
                    className={cn("relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl", owner ? "bg-gray-400 mr-3" : "bg-white mr-2")}
                >
                    <div>{message}</div>
                </div>
            </div>
