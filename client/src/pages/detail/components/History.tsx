        ...
        <div className=" border-b border-b-gray-100">
            <div className="w-full max-w-[1170px]  mx-auto pt-[40px] pb-[40px] font-sans">
                <div className="grid 2xs:grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <h3 className="text-3xl font-medium leading-3 capitalize mt-5 mb-4"> Wine history</h3>
                        <span className="text-[15px] text-gray-400 font-normal leading-[28px]">Wine is an alcoholic beverage fermented from grapes. The natural chemical balance allows grapes to ferment without the need for added sugars, acids, enzymes, water or other nutrients. Yeast consumes the sugars in the grapes and converts them into alcohol and carbon dioxide. Different grape varieties and different yeast strains form different forms of wine.</span>
                    </div>
                </div>
                <div className="grid 2xs:grid-cols-1 md:grid-cols-2 gap-4 mt-10">
                    <div>
                        <h3 className="text-3xl font-medium leading-3 capitalize mt-5 mb-4">Uses of alcohol</h3>
                        <span className="text-[15px] text-gray-400 font-normal leading-[28px]">Wine is an alcoholic beverage fermented from grapes. The natural chemical balance allows grapes to ferment without the need for added sugars, acids, enzymes, water or other nutrients. Yeast consumes the sugars in the grapes and converts them into alcohol and carbon dioxide. Different grape varieties and different yeast strains form different forms of wine.</span>
                    </div>
